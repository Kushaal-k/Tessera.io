...
import { 
  ...
  Building2, PenTool, Kanban, Lock, Users, Scale, Microscope, Layers
} from 'lucide-react';
    ...
    return (
      <button
        ...
        className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 ${
          isActive ? 'bg-slate-800/80 text-white shadow-lg border border-slate-700/50' : 'text-slate-400 hover:bg-slate-800/40 hover:text-slate-200 border border-transparent'
        }`}
      >
      ...
      <main className="flex-1 flex flex-col relative z-10 bg-[#0b0f19]/40 min-w-0">
        <header className="h-12 bg-slate-950/60 backdrop-blur-md border-b border-slate-800/80 flex items-center justify-between px-6 z-20 shrink-0">
          <div className="text-xs text-slate-400 font-mono flex items-center gap-2 truncate">
            <span className="hidden sm:inline">Project: Tessera OS v50</span>
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div className="flex items-center gap-1.5 text-xs">
              ...
              <span className="text-emerald-400 font-medium">All 50 Subsystems Online</span>
            </div>
          </div>
        </header>
