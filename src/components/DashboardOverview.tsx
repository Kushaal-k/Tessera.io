...
export const DashboardOverview = ({ onNavigate }: { onNavigate: (view: string) => void }) => {
  const roadmapPhases = [
    ...
    { num: 101, title: 'Global Command', view: 'GlobalCommandCenter' },
    { num: 102, title: 'Gov Fabric', view: 'EngineeringGovernanceFabric' },
    { num: 103, title: 'AI Strategy', view: 'AIEngineeringStrategy' },
    { num: 104, title: 'Repo Grid', view: 'GlobalRepositoryGrid' },
    { num: 105, title: 'Knowledge Universe', view: 'EngineeringKnowledgeUniverse' },
    { num: 106, title: 'Governance AI', view: 'AutoGovernanceAI' },
    { num: 107, title: 'Self-Healing', view: 'SelfHealingPlatform' },
    { num: 108, title: 'Arch Civilization', view: 'AIArchitectureCivilization' },
    { num: 109, title: 'Digital Identity', view: 'DeveloperDigitalIdentity' },
    { num: 110, title: 'Workforce Opt', view: 'AIWorkforceOptimization' },
    { num: 111, title: 'Metaverse', view: 'EngineeringMetaverse' },
    { num: 112, title: 'Research Grid', view: 'GlobalResearchGrid' },
    { num: 113, title: 'Eng Economics', view: 'EngineeringEconomics' },
    { num: 114, title: 'Innovation Engine', view: 'AutonomousInnovationEngine' },
    { num: 115, title: 'OS Intelligence', view: 'GlobalOSIntelligence' },
    { num: 116, title: 'AI Economy', view: 'AIEngineeringEconomy' },
    { num: 117, title: 'Security Mesh', view: 'AutoSecurityMesh' },
    { num: 118, title: 'Data Lakehouse', view: 'EngineeringDataLakehouse' },
    { num: 119, title: 'Eng Federation', view: 'GlobalEngineeringFederation' },
    { num: 120, title: 'Sim Simulator', view: 'SoftwareCivilizationSimulator' },
    { num: 121, title: 'Supergraph', view: 'EngineeringIntelligenceSupergraph' },
    { num: 122, title: 'Agent Society', view: 'AutonomousAgentSociety' },
    { num: 123, title: 'Operating Fabric', view: 'GlobalOperatingFabric' },
    { num: 124, title: 'Singularity Prep', view: 'SingularityPrepPlatform' },
    { num: 125, title: 'Tessera Civilization', view: 'TesseraGlobalCivilization' }
  ];

  return (
    <div className="flex-1 flex flex-col p-6 h-full relative z-10 overflow-y-auto custom-scrollbar">
      <div className="mb-6 p-8 rounded-2xl glass-panel bg-gradient-to-r from-purple-900/40 to-indigo-900/40 border border-purple-800/80 relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex gap-6 items-center">
          <div className="p-4 rounded-full bg-purple-500/10 border border-purple-500/30">
            <Crown size={48} className="text-purple-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.8)]" />
          </div>
          <div>
            <h1 className="text-4xl font-extrabold text-white mb-2">Tessera Global Civilization</h1>
            <p className="text-purple-200/80 max-w-2xl text-lg">
              Phase 125 Achieved: The World's First Global Autonomous Engineering Civilization is fully online and operational.
            </p>
            <div className="mt-4 flex gap-3">
              <button onClick={() => onNavigate('TesseraGlobalCivilization')} className="px-6 py-2 rounded-lg bg-purple-500 hover:bg-purple-600 text-slate-900 font-bold transition-all shadow-[0_0_20px_rgba(168,85,247,0.4)]">
                Initialize Global Civilization
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div className="lg:col-span-2 grid grid-cols-2 gap-4">
          <div className="glass-panel p-5 border border-slate-800/80 rounded-xl bg-slate-950/50 flex flex-col justify-between cursor-pointer hover:border-emerald-500/50" onClick={() => onNavigate('TesseraGlobalCivilization')}>
            <div className="flex items-start justify-between">
              <div>
                <p className="text-slate-400 text-xs font-medium">Civilization Scale</p>
                <h3 className="text-3xl font-black text-slate-100 mt-1">125 Phases</h3>
              </div>
              <div className="p-2 rounded-lg bg-emerald-500/20 text-emerald-400"><Activity size={20} /></div>
            </div>
          </div>
          <div className="glass-panel p-5 border border-slate-800/80 rounded-xl bg-slate-950/50 flex flex-col justify-between cursor-pointer hover:border-purple-500/50" onClick={() => onNavigate('SoftwareCivilizationSimulator')}>
            <div className="flex items-start justify-between">
              <div>
                <p className="text-slate-400 text-xs font-medium">Metaverse Network</p>
                <h3 className="text-2xl font-bold text-slate-100 mt-1">Billions of Nodes</h3>
              </div>
              <div className="p-2 rounded-lg bg-purple-500/20 text-purple-400"><Layers size={20} /></div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel border border-slate-800/80 rounded-xl bg-slate-950/50 flex flex-col h-96">
          <div className="p-4 border-b border-slate-800 flex justify-between items-center">
            <div>
              <h3 className="font-bold text-slate-200">Civilization Explorer</h3>
              <p className="text-xs text-slate-500">Full 1-125 Roadmap</p>
            </div>
